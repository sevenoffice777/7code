...
<body>
    ...
    <div class="container secondScreen">
        <div class="start_website">
            ...
            <div class="left">
                <div class="text">
                    <h1>Seção <b>EMPRÉSTIMO</b></h1>
                    <p>Aqui você pode fazer um <b>EMPRÉSTIMO</b> com as menores taxas de pagamento do mundo!</p>
                </div>
            </div>
            <div class="right">
                <div class="card">
                    <h1>EMPRÉSTIMO</h1>
                    <form>
                        <label for="pixValue">Valor do Empréstimo</label>
                        ...
                        <button type="submit" id="submitEmprestimo">
                            FAZER O EMPRÉSTIMO
                        </button>
                    </form>
                </div>
